...
int main() {
    for (int i = 0; i < 60; i++) {
        ...
        ifstream fin("D://infa/pskda_aicd/alsu/tests/test" + to_string(i + 1) + ".txt");
        ...
        out.open("C:\\Users\\alsuy\\Desktop\\AISD\\Homeworks\\Semestrovaya2\\Tests\\test" + to_string(i + 1) + ".txt"); // окрываем файл для записи
